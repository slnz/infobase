...
#ifndef API_WRAP_C
#undef OCIEnvInit
#define OCIEnvInit(envp, mode, xtramem_sz, usrmempp) \
      oci8_OCIEnvInit(envp, mode, xtramem_sz, usrmempp, __FILE__, __LINE__)
#endif
#if defined RUNTIME_API_CHECK
extern int oci8_have_OCIEnvInit;
#define have_OCIEnvInit oci8_have_OCIEnvInit
#elif ORACLE_CLIENT_VERSION >= ORAVER_8_0
#define have_OCIEnvInit (1)
#else
#define have_OCIEnvInit (0)
#endif
...
#ifndef API_WRAP_C
#undef OCIInitialize
#define OCIInitialize(mode, ctxp, malocfp, ralocfp, mfreefp) \
      oci8_OCIInitialize(mode, ctxp, malocfp, ralocfp, mfreefp, __FILE__, __LINE__)
#endif
#if defined RUNTIME_API_CHECK
extern int oci8_have_OCIInitialize;
#define have_OCIInitialize oci8_have_OCIInitialize
#elif ORACLE_CLIENT_VERSION >= ORAVER_8_0
#define have_OCIInitialize (1)
#else
#define have_OCIInitialize (0)
#endif
...
#define OCILobGetLength_nb(svcctx, svchp, errhp, locp, lenp) \
      oci8_OCILobGetLength_nb(svcctx, svchp, errhp, locp, lenp, __FILE__, __LINE__)
#if defined RUNTIME_API_CHECK
extern int oci8_have_OCILobGetLength_nb;
#define have_OCILobGetLength_nb oci8_have_OCILobGetLength_nb
#elif ORACLE_CLIENT_VERSION >= ORAVER_8_0
#define have_OCILobGetLength_nb (1)
#else
#define have_OCILobGetLength_nb (0)
#endif
...
#define OCILobRead_nb(svcctx, svchp, errhp, locp, amtp, offset, bufp, bufl, ctxp, cbfp, csid, csfrm) \
      oci8_OCILobRead_nb(svcctx, svchp, errhp, locp, amtp, offset, bufp, bufl, ctxp, cbfp, csid, csfrm, __FILE__, __LINE__)
#if defined RUNTIME_API_CHECK
extern int oci8_have_OCILobRead_nb;
#define have_OCILobRead_nb oci8_have_OCILobRead_nb
#elif ORACLE_CLIENT_VERSION >= ORAVER_8_0
#define have_OCILobRead_nb (1)
#else
#define have_OCILobRead_nb (0)
#endif
...
#define OCILobTrim_nb(svcctx, svchp, errhp, locp, newlen) \
      oci8_OCILobTrim_nb(svcctx, svchp, errhp, locp, newlen, __FILE__, __LINE__)
#if defined RUNTIME_API_CHECK
extern int oci8_have_OCILobTrim_nb;
#define have_OCILobTrim_nb oci8_have_OCILobTrim_nb
#elif ORACLE_CLIENT_VERSION >= ORAVER_8_0
#define have_OCILobTrim_nb (1)
#else
#define have_OCILobTrim_nb (0)
#endif
...
#define OCILobWrite_nb(svcctx, svchp, errhp, locp, amtp, offset, bufp, buflen, piece, ctxp, cbfp, csid, csfrm) \
      oci8_OCILobWrite_nb(svcctx, svchp, errhp, locp, amtp, offset, bufp, buflen, piece, ctxp, cbfp, csid, csfrm, __FILE__, __LINE__)
#if defined RUNTIME_API_CHECK
extern int oci8_have_OCILobWrite_nb;
#define have_OCILobWrite_nb oci8_have_OCILobWrite_nb
#elif ORACLE_CLIENT_VERSION >= ORAVER_8_0
#define have_OCILobWrite_nb (1)
#else
#define have_OCILobWrite_nb (0)
#endif
...
#define OCILogoff_nb(svcctx, svchp, errhp) \
      oci8_OCILogoff_nb(svcctx, svchp, errhp, __FILE__, __LINE__)
#if defined RUNTIME_API_CHECK
extern int oci8_have_OCILogoff_nb;
#define have_OCILogoff_nb oci8_have_OCILogoff_nb
#elif ORACLE_CLIENT_VERSION >= ORAVER_8_0
#define have_OCILogoff_nb (1)
#else
#define have_OCILogoff_nb (0)
#endif
...
#define OCILogon_nb(svcctx, envhp, errhp, svchp, username, uname_len, password, passwd_len, dbname, dbname_len) \
      oci8_OCILogon_nb(svcctx, envhp, errhp, svchp, username, uname_len, password, passwd_len, dbname, dbname_len, __FILE__, __LINE__)
#if defined RUNTIME_API_CHECK
extern int oci8_have_OCILogon_nb;
#define have_OCILogon_nb oci8_have_OCILogon_nb
#elif ORACLE_CLIENT_VERSION >= ORAVER_8_0
#define have_OCILogon_nb (1)
#else
#define have_OCILogon_nb (0)
#endif
...
#define OCIServerDetach_nb(svcctx, srvhp, errhp, mode) \
      oci8_OCIServerDetach_nb(svcctx, srvhp, errhp, mode, __FILE__, __LINE__)
#if defined RUNTIME_API_CHECK
extern int oci8_have_OCIServerDetach_nb;
#define have_OCIServerDetach_nb oci8_have_OCIServerDetach_nb
#elif ORACLE_CLIENT_VERSION >= ORAVER_8_0
#define have_OCIServerDetach_nb (1)
#else
#define have_OCIServerDetach_nb (0)
#endif
...
#define OCISessionEnd_nb(svcctx, svchp, errhp, usrhp, mode) \
      oci8_OCISessionEnd_nb(svcctx, svchp, errhp, usrhp, mode, __FILE__, __LINE__)
#if defined RUNTIME_API_CHECK
extern int oci8_have_OCISessionEnd_nb;
#define have_OCISessionEnd_nb oci8_have_OCISessionEnd_nb
#elif ORACLE_CLIENT_VERSION >= ORAVER_8_0
#define have_OCISessionEnd_nb (1)
#else
#define have_OCISessionEnd_nb (0)
#endif
...
#ifndef API_WRAP_C
#undef OCIStmtGetPieceInfo
#define OCIStmtGetPieceInfo(stmtp, errhp, hndlpp, typep, in_outp, iterp, idxp, piecep) \
      oci8_OCIStmtGetPieceInfo(stmtp, errhp, hndlpp, typep, in_outp, iterp, idxp, piecep, __FILE__, __LINE__)
#endif
#if defined RUNTIME_API_CHECK
extern int oci8_have_OCIStmtGetPieceInfo;
#define have_OCIStmtGetPieceInfo oci8_have_OCIStmtGetPieceInfo
#elif ORACLE_CLIENT_VERSION >= ORAVER_8_0
#define have_OCIStmtGetPieceInfo (1)
#else
#define have_OCIStmtGetPieceInfo (0)
#endif
...
#define OCIStmtPrepare(stmtp, errhp, stmt, stmt_len, language, mode) \
      oci8_OCIStmtPrepare(stmtp, errhp, stmt, stmt_len, language, mode, __FILE__, __LINE__)
#endif
#if defined RUNTIME_API_CHECK
extern int oci8_have_OCIStmtPrepare;
#define have_OCIStmtPrepare oci8_have_OCIStmtPrepare
#elif ORACLE_CLIENT_VERSION >= ORAVER_8_0
#define have_OCIStmtPrepare (1)
#else
#define have_OCIStmtPrepare (0)
#endif
...
#ifndef API_WRAP_C
#undef OCIStmtSetPieceInfo
#define OCIStmtSetPieceInfo(hndlp, type, errhp, bufp, alenp, piece, indp, rcodep) \
      oci8_OCIStmtSetPieceInfo(hndlp, type, errhp, bufp, alenp, piece, indp, rcodep, __FILE__, __LINE__)
#endif
#if defined RUNTIME_API_CHECK
extern int oci8_have_OCIStmtSetPieceInfo;
#define have_OCIStmtSetPieceInfo oci8_have_OCIStmtSetPieceInfo
#elif ORACLE_CLIENT_VERSION >= ORAVER_8_0
#define have_OCIStmtSetPieceInfo (1)
#else
#define have_OCIStmtSetPieceInfo (0)
#endif
...
#ifndef API_WRAP_C
#undef OCIReset
#define OCIReset(hndlp, errhp) \
      oci8_OCIReset(hndlp, errhp, __FILE__, __LINE__)
#endif
#if defined RUNTIME_API_CHECK
extern int oci8_have_OCIReset;
#define have_OCIReset oci8_have_OCIReset
#elif ORACLE_CLIENT_VERSION >= ORAVER_8_1
#define have_OCIReset (1)
#else
#define have_OCIReset (0)
#endif
...
#ifndef API_WRAP_C
#undef OCIIntervalFromText
#define OCIIntervalFromText(hndl, err, inpstr, str_len, result) \
      oci8_OCIIntervalFromText(hndl, err, inpstr, str_len, result, __FILE__, __LINE__)
#endif
#if defined RUNTIME_API_CHECK
extern int oci8_have_OCIIntervalFromText;
#define have_OCIIntervalFromText oci8_have_OCIIntervalFromText
#elif ORACLE_CLIENT_VERSION >= ORAVER_9_0
#define have_OCIIntervalFromText (1)
#else
#define have_OCIIntervalFromText (0)
#endif
...
#define OCIDBShutdown_nb(svcctx, svchp, errhp, admhp, mode) \
      oci8_OCIDBShutdown_nb(svcctx, svchp, errhp, admhp, mode, __FILE__, __LINE__)
#if defined RUNTIME_API_CHECK
extern int oci8_have_OCIDBShutdown_nb;
#define have_OCIDBShutdown_nb oci8_have_OCIDBShutdown_nb
#elif ORACLE_CLIENT_VERSION >= ORAVER_10_2
#define have_OCIDBShutdown_nb (1)
#else
#define have_OCIDBShutdown_nb (0)
#endif
...
#define OCIDBStartup_nb(svcctx, svchp, errhp, admhp, mode, flags) \
      oci8_OCIDBStartup_nb(svcctx, svchp, errhp, admhp, mode, flags, __FILE__, __LINE__)
#if defined RUNTIME_API_CHECK
extern int oci8_have_OCIDBStartup_nb;
#define have_OCIDBStartup_nb oci8_have_OCIDBStartup_nb
#elif ORACLE_CLIENT_VERSION >= ORAVER_10_2
#define have_OCIDBStartup_nb (1)
#else
#define have_OCIDBStartup_nb (0)
#endif
...
#ifndef API_WRAP_C
#undef OCIArrayDescriptorAlloc
#define OCIArrayDescriptorAlloc(parenth, descpp, type, array_size, xtramem_sz, usrmempp) \
      oci8_OCIArrayDescriptorAlloc(parenth, descpp, type, array_size, xtramem_sz, usrmempp, __FILE__, __LINE__)
#endif
#if defined RUNTIME_API_CHECK
extern int oci8_have_OCIArrayDescriptorAlloc;
#define have_OCIArrayDescriptorAlloc oci8_have_OCIArrayDescriptorAlloc
#elif ORACLE_CLIENT_VERSION >= ORAVER_11_1
#define have_OCIArrayDescriptorAlloc (1)
#else
#define have_OCIArrayDescriptorAlloc (0)
#endif
...
#ifndef API_WRAP_C
#undef OCIArrayDescriptorFree
#define OCIArrayDescriptorFree(descp, type) \
      oci8_OCIArrayDescriptorFree(descp, type, __FILE__, __LINE__)
#endif
#if defined RUNTIME_API_CHECK
extern int oci8_have_OCIArrayDescriptorFree;
#define have_OCIArrayDescriptorFree oci8_have_OCIArrayDescriptorFree
#elif ORACLE_CLIENT_VERSION >= ORAVER_11_1
#define have_OCIArrayDescriptorFree (1)
#else
#define have_OCIArrayDescriptorFree (0)
#endif
