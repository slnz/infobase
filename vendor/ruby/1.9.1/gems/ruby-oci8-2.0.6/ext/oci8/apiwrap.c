...
/* OCIEnvInit */
#if defined RUNTIME_API_CHECK
typedef sword (*oci8_OCIEnvInit_func_t)(OCIEnv **envp, ub4 mode, size_t xtramem_sz, dvoid **usrmempp);
static oci8_OCIEnvInit_func_t oci8_OCIEnvInit_func;
#define OCIEnvInit oci8_OCIEnvInit_func
#elif ORACLE_CLIENT_VERSION < ORAVER_8_0
#define OCIEnvInit(envp, mode, xtramem_sz, usrmempp) (0)
#endif
...
/* OCIInitialize */
#if defined RUNTIME_API_CHECK
typedef sword (*oci8_OCIInitialize_func_t)(ub4 mode, dvoid *ctxp, dvoid *(*malocfp)(dvoid *ctxp, size_t size), dvoid *(*ralocfp)(dvoid *ctxp, dvoid *memptr, size_t newsize), void   (*mfreefp)(dvoid *ctxp, dvoid *memptr));
static oci8_OCIInitialize_func_t oci8_OCIInitialize_func;
#define OCIInitialize oci8_OCIInitialize_func
#elif ORACLE_CLIENT_VERSION < ORAVER_8_0
#define OCIInitialize(mode, ctxp, malocfp, ralocfp, mfreefp) (0)
#endif
...
/* OCILobGetLength */
#if defined RUNTIME_API_CHECK
typedef sword (*oci8_OCILobGetLength_func_t)(OCISvcCtx *svchp, OCIError *errhp, OCILobLocator *locp, ub4 *lenp);
static oci8_OCILobGetLength_func_t oci8_OCILobGetLength_func;
#define OCILobGetLength oci8_OCILobGetLength_func
#elif ORACLE_CLIENT_VERSION < ORAVER_8_0
#define OCILobGetLength(svchp, errhp, locp, lenp) (0)
#endif
...
/* OCILobRead */
#if defined RUNTIME_API_CHECK
typedef sword (*oci8_OCILobRead_func_t)(OCISvcCtx *svchp, OCIError *errhp, OCILobLocator *locp, ub4 *amtp, ub4 offset, dvoid *bufp, ub4 bufl, dvoid *ctxp, OCICallbackLobRead cbfp, ub2 csid, ub1 csfrm);
static oci8_OCILobRead_func_t oci8_OCILobRead_func;
#define OCILobRead oci8_OCILobRead_func
#elif ORACLE_CLIENT_VERSION < ORAVER_8_0
#define OCILobRead(svchp, errhp, locp, amtp, offset, bufp, bufl, ctxp, cbfp, csid, csfrm) (0)
#endif

/* OCILobTrim */
#if defined RUNTIME_API_CHECK
typedef sword (*oci8_OCILobTrim_func_t)(OCISvcCtx *svchp, OCIError *errhp, OCILobLocator *locp, ub4 newlen);
static oci8_OCILobTrim_func_t oci8_OCILobTrim_func;
#define OCILobTrim oci8_OCILobTrim_func
#elif ORACLE_CLIENT_VERSION < ORAVER_8_0
#define OCILobTrim(svchp, errhp, locp, newlen) (0)
#endif

/* OCILobWrite */
#if defined RUNTIME_API_CHECK
typedef sword (*oci8_OCILobWrite_func_t)(OCISvcCtx *svchp, OCIError *errhp, OCILobLocator *locp, ub4 *amtp, ub4 offset, dvoid *bufp, ub4 buflen, ub1 piece, dvoid *ctxp, OCICallbackLobWrite cbfp, ub2 csid, ub1 csfrm);
static oci8_OCILobWrite_func_t oci8_OCILobWrite_func;
#define OCILobWrite oci8_OCILobWrite_func
#elif ORACLE_CLIENT_VERSION < ORAVER_8_0
#define OCILobWrite(svchp, errhp, locp, amtp, offset, bufp, buflen, piece, ctxp, cbfp, csid, csfrm) (0)
#endif

/* OCILogoff */
#if defined RUNTIME_API_CHECK
typedef sword (*oci8_OCILogoff_func_t)(OCISvcCtx *svchp, OCIError *errhp);
static oci8_OCILogoff_func_t oci8_OCILogoff_func;
#define OCILogoff oci8_OCILogoff_func
#elif ORACLE_CLIENT_VERSION < ORAVER_8_0
#define OCILogoff(svchp, errhp) (0)
#endif

/* OCILogon */
#if defined RUNTIME_API_CHECK
typedef sword (*oci8_OCILogon_func_t)(OCIEnv *envhp, OCIError *errhp, OCISvcCtx **svchp, CONST text *username, ub4 uname_len, CONST text *password, ub4 passwd_len, CONST text *dbname, ub4 dbname_len);
static oci8_OCILogon_func_t oci8_OCILogon_func;
#define OCILogon oci8_OCILogon_func
#elif ORACLE_CLIENT_VERSION < ORAVER_8_0
#define OCILogon(envhp, errhp, svchp, username, uname_len, password, passwd_len, dbname, dbname_len) (0)
#endif
...
/* OCIStmtGetPieceInfo */
#if defined RUNTIME_API_CHECK
typedef sword (*oci8_OCIStmtGetPieceInfo_func_t)(OCIStmt *stmtp, OCIError *errhp, dvoid **hndlpp, ub4 *typep, ub1 *in_outp, ub4 *iterp, ub4 *idxp, ub1 *piecep);
static oci8_OCIStmtGetPieceInfo_func_t oci8_OCIStmtGetPieceInfo_func;
#define OCIStmtGetPieceInfo oci8_OCIStmtGetPieceInfo_func
#elif ORACLE_CLIENT_VERSION < ORAVER_8_0
#define OCIStmtGetPieceInfo(stmtp, errhp, hndlpp, typep, in_outp, iterp, idxp, piecep) (0)
#endif

/* OCIStmtPrepare */
#if defined RUNTIME_API_CHECK
typedef sword (*oci8_OCIStmtPrepare_func_t)(OCIStmt *stmtp, OCIError *errhp, CONST text *stmt, ub4 stmt_len, ub4 language, ub4 mode);
static oci8_OCIStmtPrepare_func_t oci8_OCIStmtPrepare_func;
#define OCIStmtPrepare oci8_OCIStmtPrepare_func
#elif ORACLE_CLIENT_VERSION < ORAVER_8_0
#define OCIStmtPrepare(stmtp, errhp, stmt, stmt_len, language, mode) (0)
#endif

/* OCIStmtSetPieceInfo */
#if defined RUNTIME_API_CHECK
typedef sword (*oci8_OCIStmtSetPieceInfo_func_t)(dvoid *hndlp, ub4 type, OCIError *errhp, CONST dvoid *bufp, ub4 *alenp, ub1 piece, CONST dvoid *indp, ub2 *rcodep);
static oci8_OCIStmtSetPieceInfo_func_t oci8_OCIStmtSetPieceInfo_func;
#define OCIStmtSetPieceInfo oci8_OCIStmtSetPieceInfo_func
#elif ORACLE_CLIENT_VERSION < ORAVER_8_0
#define OCIStmtSetPieceInfo(hndlp, type, errhp, bufp, alenp, piece, indp, rcodep) (0)
#endif
...
/* OCIReset */
#if defined RUNTIME_API_CHECK
typedef sword (*oci8_OCIReset_func_t)(dvoid *hndlp, OCIError *errhp);
static oci8_OCIReset_func_t oci8_OCIReset_func;
#define OCIReset oci8_OCIReset_func
#elif ORACLE_CLIENT_VERSION < ORAVER_8_1
#define OCIReset(hndlp, errhp) (0)
#endif
...
/* OCIIntervalFromText */
#if defined RUNTIME_API_CHECK
typedef sword (*oci8_OCIIntervalFromText_func_t)(dvoid *hndl, OCIError *err, CONST OraText *inpstr, size_t str_len, OCIInterval *result);
static oci8_OCIIntervalFromText_func_t oci8_OCIIntervalFromText_func;
#define OCIIntervalFromText oci8_OCIIntervalFromText_func
#elif ORACLE_CLIENT_VERSION < ORAVER_9_0
#define OCIIntervalFromText(hndl, err, inpstr, str_len, result) (0)
#endif
...
/* OCIDBShutdown */
#if defined RUNTIME_API_CHECK
typedef sword (*oci8_OCIDBShutdown_func_t)(OCISvcCtx *svchp, OCIError *errhp, OCIAdmin *admhp, ub4 mode);
static oci8_OCIDBShutdown_func_t oci8_OCIDBShutdown_func;
#define OCIDBShutdown oci8_OCIDBShutdown_func
#elif ORACLE_CLIENT_VERSION < ORAVER_10_2
#define OCIDBShutdown(svchp, errhp, admhp, mode) (0)
#endif

/* OCIDBStartup */
#if defined RUNTIME_API_CHECK
typedef sword (*oci8_OCIDBStartup_func_t)(OCISvcCtx *svchp, OCIError *errhp, OCIAdmin *admhp, ub4 mode, ub4 flags);
static oci8_OCIDBStartup_func_t oci8_OCIDBStartup_func;
#define OCIDBStartup oci8_OCIDBStartup_func
#elif ORACLE_CLIENT_VERSION < ORAVER_10_2
#define OCIDBStartup(svchp, errhp, admhp, mode, flags) (0)
#endif
...
#if defined RUNTIME_API_CHECK
typedef sword (*oci8_OCIArrayDescriptorAlloc_func_t)(const void *parenth, void **descpp, const ub4 type, ub4 array_size, const size_t xtramem_sz, void **usrmempp);
static oci8_OCIArrayDescriptorAlloc_func_t oci8_OCIArrayDescriptorAlloc_func;
#define OCIArrayDescriptorAlloc oci8_OCIArrayDescriptorAlloc_func
#elif ORACLE_CLIENT_VERSION < ORAVER_11_1
#define OCIArrayDescriptorAlloc(parenth, descpp, type, array_size, xtramem_sz, usrmempp) (0)
#endif

/* OCIArrayDescriptorFree */
#if defined RUNTIME_API_CHECK
typedef sword (*oci8_OCIArrayDescriptorFree_func_t)(void **descp, const ub4 type);
static oci8_OCIArrayDescriptorFree_func_t oci8_OCIArrayDescriptorFree_func;
#define OCIArrayDescriptorFree oci8_OCIArrayDescriptorFree_func
#elif ORACLE_CLIENT_VERSION < ORAVER_11_1
#define OCIArrayDescriptorFree(descp, type) (0)
#endif
...
static VALUE oci8_OCIAttrGet_cb(void *user_data)
{
...
sword oci8_OCIAttrGet_nb(oci8_svcctx_t *svcctx, CONST dvoid *trgthndlp, ub4 trghndltyp, dvoid *attributep, ub4 *sizep, ub4 attrtype, OCIError *errhp, const char *file, int line)
{
    if (have_OCIAttrGet_nb) {
        ...
        data.errhp = errhp;
        oci8_blocking_region(svcctx, oci8_OCIAttrGet_cb, &data);
        return data.rv;
    } else {
...
#if defined RUNTIME_API_CHECK || ORACLE_CLIENT_VERSION >= ORAVER_8_0
static VALUE oci8_OCIDescribeAny_cb(void *user_data)
{
...
sword oci8_OCIDescribeAny_nb(oci8_svcctx_t *svcctx, OCISvcCtx *svchp, OCIError *errhp, dvoid *objptr, ub4 objnm_len, ub1 objptr_typ, ub1 info_level, ub1 objtyp, OCIDescribe *dschp, const char *file, int line)
{
    if (have_OCIDescribeAny_nb) {
        ...
        data.objtyp = objtyp;
        data.dschp = dschp;
        oci8_blocking_region(svcctx, oci8_OCIDescribeAny_cb, &data);
        return data.rv;
    } else {
 ...
 */
#if defined RUNTIME_API_CHECK
int oci8_have_OCIEnvInit;
#endif

sword oci8_OCIEnvInit(OCIEnv **envp, ub4 mode, size_t xtramem_sz, dvoid **usrmempp, const char *file, int line)
{
    if (have_OCIEnvInit) {
        return OCIEnvInit(envp, mode, xtramem_sz, usrmempp);
    } else {
        rb_raise(rb_eRuntimeError, "undefined OCI function %s is called", "OCIEnvInit");
    }
}
 ...
 */
#if defined RUNTIME_API_CHECK
int oci8_have_OCIInitialize;
#endif

sword oci8_OCIInitialize(ub4 mode, dvoid *ctxp, dvoid *(*malocfp)(dvoid *ctxp, size_t size), dvoid *(*ralocfp)(dvoid *ctxp, dvoid *memptr, size_t newsize), void   (*mfreefp)(dvoid *ctxp, dvoid *memptr), const char *file, int line)
{
    if (have_OCIInitialize) {
        return OCIInitialize(mode, ctxp, malocfp, ralocfp, mfreefp);
    } else {
        rb_raise(rb_eRuntimeError, "undefined OCI function %s is called", "OCIInitialize");
    }
}
...
#if defined RUNTIME_API_CHECK || ORACLE_CLIENT_VERSION >= ORAVER_8_0
static VALUE oci8_OCILobFileClose_cb(void *user_data)
{
...
sword oci8_OCILobFileClose_nb(oci8_svcctx_t *svcctx, OCISvcCtx *svchp, OCIError *errhp, OCILobLocator *filep, const char *file, int line)
{
    if (have_OCILobFileClose_nb) {
        ...
        data.errhp = errhp;
        data.filep = filep;
        oci8_blocking_region(svcctx, oci8_OCILobFileClose_cb, &data);
        return data.rv;
    } else {
...
#if defined RUNTIME_API_CHECK || ORACLE_CLIENT_VERSION >= ORAVER_8_0
static VALUE oci8_OCILobFileCloseAll_cb(void *user_data)
{
...
sword oci8_OCILobFileCloseAll_nb(oci8_svcctx_t *svcctx, OCISvcCtx *svchp, OCIError *errhp, const char *file, int line)
{
    if (have_OCILobFileCloseAll_nb) {
        ...
        data.svchp = svchp;
        data.errhp = errhp;
        oci8_blocking_region(svcctx, oci8_OCILobFileCloseAll_cb, &data);
        return data.rv;
    } else {
...
#if defined RUNTIME_API_CHECK || ORACLE_CLIENT_VERSION >= ORAVER_8_0
static VALUE oci8_OCILobFileExists_cb(void *user_data)
{
...
sword oci8_OCILobFileExists_nb(oci8_svcctx_t *svcctx, OCISvcCtx *svchp, OCIError *errhp, OCILobLocator *filep, boolean *flag, const char *file, int line)
{
    if (have_OCILobFileExists_nb) {
        ...
        data.filep = filep;
        data.flag = flag;
        oci8_blocking_region(svcctx, oci8_OCILobFileExists_cb, &data);
        return data.rv;
    } else {
...
#if defined RUNTIME_API_CHECK || ORACLE_CLIENT_VERSION >= ORAVER_8_0
static VALUE oci8_OCILobFileOpen_cb(void *user_data)
{
...
sword oci8_OCILobFileOpen_nb(oci8_svcctx_t *svcctx, OCISvcCtx *svchp, OCIError *errhp, OCILobLocator *filep, ub1 mode, const char *file, int line)
{
    if (have_OCILobFileOpen_nb) {
        ...
        data.filep = filep;
        data.mode = mode;
        oci8_blocking_region(svcctx, oci8_OCILobFileOpen_cb, &data);
        return data.rv;
    } else {
...
typedef struct {
    ...
    OCILobLocator *locp;
    ub4 *lenp;
} oci8_OCILobGetLength_data_t;

#if defined RUNTIME_API_CHECK
int oci8_have_OCILobGetLength_nb;
#endif

#if defined RUNTIME_API_CHECK || ORACLE_CLIENT_VERSION >= ORAVER_8_0
static VALUE oci8_OCILobGetLength_cb(void *user_data)
{
    oci8_OCILobGetLength_data_t *data = (oci8_OCILobGetLength_data_t *)user_data;
    data->rv = OCILobGetLength(data->svchp, data->errhp, data->locp, data->lenp);

    return (VALUE)data->rv;

}
#else
#define oci8_OCILobGetLength_cb NULL
#endif

sword oci8_OCILobGetLength_nb(oci8_svcctx_t *svcctx, OCISvcCtx *svchp, OCIError *errhp, OCILobLocator *locp, ub4 *lenp, const char *file, int line)
{
    if (have_OCILobGetLength_nb) {
        oci8_OCILobGetLength_data_t data;
        data.svchp = svchp;
        data.errhp = errhp;
        data.locp = locp;
        data.lenp = lenp;
        oci8_blocking_region(svcctx, oci8_OCILobGetLength_cb, &data);
        return data.rv;
    } else {
        rb_raise(rb_eRuntimeError, "undefined OCI function %s is called", "OCILobGetLength_nb");
    }
}
...
typedef struct {
    ...
    ub2 csid;
    ub1 csfrm;
} oci8_OCILobRead_data_t;

#if defined RUNTIME_API_CHECK
int oci8_have_OCILobRead_nb;
#endif

#if defined RUNTIME_API_CHECK || ORACLE_CLIENT_VERSION >= ORAVER_8_0
static VALUE oci8_OCILobRead_cb(void *user_data)
{
    oci8_OCILobRead_data_t *data = (oci8_OCILobRead_data_t *)user_data;
    data->rv = OCILobRead(data->svchp, data->errhp, data->locp, data->amtp, data->offset, data->bufp, data->bufl, data->ctxp, data->cbfp, data->csid, data->csfrm);

    return (VALUE)data->rv;

}
#else
#define oci8_OCILobRead_cb NULL
#endif

sword oci8_OCILobRead_nb(oci8_svcctx_t *svcctx, OCISvcCtx *svchp, OCIError *errhp, OCILobLocator *locp, ub4 *amtp, ub4 offset, dvoid *bufp, ub4 bufl, dvoid *ctxp, OCICallbackLobRead cbfp, ub2 csid, ub1 csfrm, const char *file, int line)
{
    if (have_OCILobRead_nb) {
        oci8_OCILobRead_data_t data;
        data.svchp = svchp;
        data.errhp = errhp;
        data.locp = locp;
        data.amtp = amtp;
        ...
        data.csid = csid;
        data.csfrm = csfrm;
        oci8_blocking_region(svcctx, oci8_OCILobRead_cb, &data);
        return data.rv;
    } else {
        rb_raise(rb_eRuntimeError, "undefined OCI function %s is called", "OCILobRead_nb");
    }
}
...
typedef struct {
    ...
    OCILobLocator *locp;
    ub4 newlen;
} oci8_OCILobTrim_data_t;

#if defined RUNTIME_API_CHECK
int oci8_have_OCILobTrim_nb;
#endif

#if defined RUNTIME_API_CHECK || ORACLE_CLIENT_VERSION >= ORAVER_8_0
static VALUE oci8_OCILobTrim_cb(void *user_data)
{
    oci8_OCILobTrim_data_t *data = (oci8_OCILobTrim_data_t *)user_data;
    data->rv = OCILobTrim(data->svchp, data->errhp, data->locp, data->newlen);

    return (VALUE)data->rv;

}
#else
#define oci8_OCILobTrim_cb NULL
#endif

sword oci8_OCILobTrim_nb(oci8_svcctx_t *svcctx, OCISvcCtx *svchp, OCIError *errhp, OCILobLocator *locp, ub4 newlen, const char *file, int line)
{
    if (have_OCILobTrim_nb) {
        oci8_OCILobTrim_data_t data;
        data.svchp = svchp;
        data.errhp = errhp;
        data.locp = locp;
        data.newlen = newlen;
        oci8_blocking_region(svcctx, oci8_OCILobTrim_cb, &data);
        return data.rv;
    } else {
        rb_raise(rb_eRuntimeError, "undefined OCI function %s is called", "OCILobTrim_nb");
    }
}
...
typedef struct {
    ...
    ub2 csid;
    ub1 csfrm;
} oci8_OCILobWrite_data_t;

#if defined RUNTIME_API_CHECK
int oci8_have_OCILobWrite_nb;
#endif

#if defined RUNTIME_API_CHECK || ORACLE_CLIENT_VERSION >= ORAVER_8_0
static VALUE oci8_OCILobWrite_cb(void *user_data)
{
    oci8_OCILobWrite_data_t *data = (oci8_OCILobWrite_data_t *)user_data;
    data->rv = OCILobWrite(data->svchp, data->errhp, data->locp, data->amtp, data->offset, data->bufp, data->buflen, data->piece, data->ctxp, data->cbfp, data->csid, data->csfrm);

    return (VALUE)data->rv;

}
#else
#define oci8_OCILobWrite_cb NULL
#endif

sword oci8_OCILobWrite_nb(oci8_svcctx_t *svcctx, OCISvcCtx *svchp, OCIError *errhp, OCILobLocator *locp, ub4 *amtp, ub4 offset, dvoid *bufp, ub4 buflen, ub1 piece, dvoid *ctxp, OCICallbackLobWrite cbfp, ub2 csid, ub1 csfrm, const char *file, int line)
{
    if (have_OCILobWrite_nb) {
        oci8_OCILobWrite_data_t data;
        data.svchp = svchp;
        data.errhp = errhp;
        data.locp = locp;
        data.amtp = amtp;
        ...
        data.csid = csid;
        data.csfrm = csfrm;
        oci8_blocking_region(svcctx, oci8_OCILobWrite_cb, &data);
        return data.rv;
    } else {
        rb_raise(rb_eRuntimeError, "undefined OCI function %s is called", "OCILobWrite_nb");
    }
}
...
typedef struct {
    ...
    OCISvcCtx *svchp;
    OCIError *errhp;
} oci8_OCILogoff_data_t;

#if defined RUNTIME_API_CHECK
int oci8_have_OCILogoff_nb;
#endif

#if defined RUNTIME_API_CHECK || ORACLE_CLIENT_VERSION >= ORAVER_8_0
static VALUE oci8_OCILogoff_cb(void *user_data)
{
    oci8_OCILogoff_data_t *data = (oci8_OCILogoff_data_t *)user_data;
    data->rv = OCILogoff(data->svchp, data->errhp);

    return (VALUE)data->rv;

}
#else
#define oci8_OCILogoff_cb NULL
#endif

sword oci8_OCILogoff_nb(oci8_svcctx_t *svcctx, OCISvcCtx *svchp, OCIError *errhp, const char *file, int line)
{
    if (have_OCILogoff_nb) {
        oci8_OCILogoff_data_t data;
        data.svchp = svchp;
        data.errhp = errhp;
        oci8_blocking_region(svcctx, oci8_OCILogoff_cb, &data);
        return data.rv;
    } else {
        rb_raise(rb_eRuntimeError, "undefined OCI function %s is called", "OCILogoff_nb");
    }
}
...
typedef struct {
    ...
    CONST text *dbname;
    ub4 dbname_len;
} oci8_OCILogon_data_t;

#if defined RUNTIME_API_CHECK
int oci8_have_OCILogon_nb;
#endif

#if defined RUNTIME_API_CHECK || ORACLE_CLIENT_VERSION >= ORAVER_8_0
static VALUE oci8_OCILogon_cb(void *user_data)
{
    oci8_OCILogon_data_t *data = (oci8_OCILogon_data_t *)user_data;
    data->rv = OCILogon(data->envhp, data->errhp, data->svchp, data->username, data->uname_len, data->password, data->passwd_len, data->dbname, data->dbname_len);

    return (VALUE)data->rv;

}
#else
#define oci8_OCILogon_cb NULL
#endif

sword oci8_OCILogon_nb(oci8_svcctx_t *svcctx, OCIEnv *envhp, OCIError *errhp, OCISvcCtx **svchp, CONST text *username, ub4 uname_len, CONST text *password, ub4 passwd_len, CONST text *dbname, ub4 dbname_len, const char *file, int line)
{
    if (have_OCILogon_nb) {
        oci8_OCILogon_data_t data;
        data.envhp = envhp;
        data.errhp = errhp;
        data.svchp = svchp;
        data.username = username;
        data.uname_len = uname_len;
        data.password = password;
        data.passwd_len = passwd_len;
        data.dbname = dbname;
        data.dbname_len = dbname_len;
        oci8_blocking_region(svcctx, oci8_OCILogon_cb, &data);
        return data.rv;
    } else {
        rb_raise(rb_eRuntimeError, "undefined OCI function %s is called", "OCILogon_nb");
    }
}
...
#if defined RUNTIME_API_CHECK || ORACLE_CLIENT_VERSION >= ORAVER_8_0
static VALUE oci8_OCIObjectPin_cb(void *user_data)
{
...
sword oci8_OCIObjectPin_nb(oci8_svcctx_t *svcctx, OCIEnv *env, OCIError *err, OCIRef *object_ref, OCIComplexObject *corhdl, OCIPinOpt pin_option, OCIDuration pin_duration, OCILockOpt lock_option, dvoid **object, const char *file, int line)
{
    if (have_OCIObjectPin_nb) {
        ...
        data.object = object;
        oci8_blocking_region(svcctx, oci8_OCIObjectPin_cb, &data);
        return data.rv;
    } else {
...
#if defined RUNTIME_API_CHECK || ORACLE_CLIENT_VERSION >= ORAVER_8_0
static VALUE oci8_OCIServerAttach_cb(void *user_data)
{
...
sword oci8_OCIServerAttach_nb(oci8_svcctx_t *svcctx, OCIServer *srvhp, OCIError *errhp, CONST text *dblink, sb4 dblink_len, ub4 mode, const char *file, int line)
{
    if (have_OCIServerAttach_nb) {
        ...
        data.mode = mode;
        oci8_blocking_region(svcctx, oci8_OCIServerAttach_cb, &data);
        return data.rv;
    } else {
...
typedef struct {
    ...
    OCIError *errhp;
    ub4 mode;
} oci8_OCIServerDetach_data_t;

#if defined RUNTIME_API_CHECK
int oci8_have_OCIServerDetach_nb;
#endif

#if defined RUNTIME_API_CHECK || ORACLE_CLIENT_VERSION >= ORAVER_8_0
static VALUE oci8_OCIServerDetach_cb(void *user_data)
{
    oci8_OCIServerDetach_data_t *data = (oci8_OCIServerDetach_data_t *)user_data;
    data->rv = OCIServerDetach(data->srvhp, data->errhp, data->mode);

    return (VALUE)data->rv;

}
#else
#define oci8_OCIServerDetach_cb NULL
#endif

sword oci8_OCIServerDetach_nb(oci8_svcctx_t *svcctx, OCIServer *srvhp, OCIError *errhp, ub4 mode, const char *file, int line)
{
    if (have_OCIServerDetach_nb) {
        oci8_OCIServerDetach_data_t data;
        data.srvhp = srvhp;
        data.errhp = errhp;
        data.mode = mode;
        oci8_blocking_region(svcctx, oci8_OCIServerDetach_cb, &data);
        return data.rv;
    } else {
        rb_raise(rb_eRuntimeError, "undefined OCI function %s is called", "OCIServerDetach_nb");
    }
}
...
#if defined RUNTIME_API_CHECK || ORACLE_CLIENT_VERSION >= ORAVER_8_0
static VALUE oci8_OCISessionBegin_cb(void *user_data)
{
...
sword oci8_OCISessionBegin_nb(oci8_svcctx_t *svcctx, OCISvcCtx *svchp, OCIError *errhp, OCISession *usrhp, ub4 credt, ub4 mode, const char *file, int line)
{
    if (have_OCISessionBegin_nb) {
        ...
        data.credt = credt;
        data.mode = mode;
        oci8_blocking_region(svcctx, oci8_OCISessionBegin_cb, &data);
        return data.rv;
    } else {
...
typedef struct {
    ...
    OCISession *usrhp;
    ub4 mode;
} oci8_OCISessionEnd_data_t;

#if defined RUNTIME_API_CHECK
int oci8_have_OCISessionEnd_nb;
#endif

#if defined RUNTIME_API_CHECK || ORACLE_CLIENT_VERSION >= ORAVER_8_0
static VALUE oci8_OCISessionEnd_cb(void *user_data)
{
    oci8_OCISessionEnd_data_t *data = (oci8_OCISessionEnd_data_t *)user_data;
    data->rv = OCISessionEnd(data->svchp, data->errhp, data->usrhp, data->mode);

    return (VALUE)data->rv;

}
#else
#define oci8_OCISessionEnd_cb NULL
#endif

sword oci8_OCISessionEnd_nb(oci8_svcctx_t *svcctx, OCISvcCtx *svchp, OCIError *errhp, OCISession *usrhp, ub4 mode, const char *file, int line)
{
    if (have_OCISessionEnd_nb) {
        oci8_OCISessionEnd_data_t data;
        data.svchp = svchp;
        data.errhp = errhp;
        data.usrhp = usrhp;
        data.mode = mode;
        oci8_blocking_region(svcctx, oci8_OCISessionEnd_cb, &data);
        return data.rv;
    } else {
        rb_raise(rb_eRuntimeError, "undefined OCI function %s is called", "OCISessionEnd_nb");
    }
}
...
#if defined RUNTIME_API_CHECK || ORACLE_CLIENT_VERSION >= ORAVER_8_0
static VALUE oci8_OCIStmtExecute_cb(void *user_data)
{
...
sword oci8_OCIStmtExecute_nb(oci8_svcctx_t *svcctx, OCISvcCtx *svchp, OCIStmt *stmtp, OCIError *errhp, ub4 iters, ub4 rowoff, CONST OCISnapshot *snap_in, OCISnapshot *snap_out, ub4 mode, const char *file, int line)
{
    if (have_OCIStmtExecute_nb) {
        ...
        data.mode = mode;
        oci8_blocking_region(svcctx, oci8_OCIStmtExecute_cb, &data);
        return data.rv;
    } else {
...
#if defined RUNTIME_API_CHECK || ORACLE_CLIENT_VERSION >= ORAVER_8_0
static VALUE oci8_OCIStmtFetch_cb(void *user_data)
{
...
sword oci8_OCIStmtFetch_nb(oci8_svcctx_t *svcctx, OCIStmt *stmtp, OCIError *errhp, ub4 nrows, ub2 orientation, ub4 mode, const char *file, int line)
{
    if (have_OCIStmtFetch_nb) {
        ...
        data.mode = mode;
        oci8_blocking_region(svcctx, oci8_OCIStmtFetch_cb, &data);
        return data.rv;
    } else {
 ...
 */
#if defined RUNTIME_API_CHECK
int oci8_have_OCIStmtGetPieceInfo;
#endif

sword oci8_OCIStmtGetPieceInfo(OCIStmt *stmtp, OCIError *errhp, dvoid **hndlpp, ub4 *typep, ub1 *in_outp, ub4 *iterp, ub4 *idxp, ub1 *piecep, const char *file, int line)
{
    if (have_OCIStmtGetPieceInfo) {
        return OCIStmtGetPieceInfo(stmtp, errhp, hndlpp, typep, in_outp, iterp, idxp, piecep);
    } else {
        rb_raise(rb_eRuntimeError, "undefined OCI function %s is called", "OCIStmtGetPieceInfo");
    }
}
 ...
 */
#if defined RUNTIME_API_CHECK
int oci8_have_OCIStmtPrepare;
#endif

sword oci8_OCIStmtPrepare(OCIStmt *stmtp, OCIError *errhp, CONST text *stmt, ub4 stmt_len, ub4 language, ub4 mode, const char *file, int line)
{
    if (have_OCIStmtPrepare) {
        return OCIStmtPrepare(stmtp, errhp, stmt, stmt_len, language, mode);
    } else {
        rb_raise(rb_eRuntimeError, "undefined OCI function %s is called", "OCIStmtPrepare");
    }
}
 ...
 */
#if defined RUNTIME_API_CHECK
int oci8_have_OCIStmtSetPieceInfo;
#endif

sword oci8_OCIStmtSetPieceInfo(dvoid *hndlp, ub4 type, OCIError *errhp, CONST dvoid *bufp, ub4 *alenp, ub1 piece, CONST dvoid *indp, ub2 *rcodep, const char *file, int line)
{
    if (have_OCIStmtSetPieceInfo) {
        return OCIStmtSetPieceInfo(hndlp, type, errhp, bufp, alenp, piece, indp, rcodep);
    } else {
        rb_raise(rb_eRuntimeError, "undefined OCI function %s is called", "OCIStmtSetPieceInfo");
    }
}
...
#if defined RUNTIME_API_CHECK || ORACLE_CLIENT_VERSION >= ORAVER_8_0
static VALUE oci8_OCITransCommit_cb(void *user_data)
{
...
sword oci8_OCITransCommit_nb(oci8_svcctx_t *svcctx, OCISvcCtx *svchp, OCIError *errhp, ub4 flags, const char *file, int line)
{
    if (have_OCITransCommit_nb) {
        ...
        data.errhp = errhp;
        data.flags = flags;
        oci8_blocking_region(svcctx, oci8_OCITransCommit_cb, &data);
        return data.rv;
    } else {
...
#if defined RUNTIME_API_CHECK || ORACLE_CLIENT_VERSION >= ORAVER_8_0
static VALUE oci8_OCITransRollback_cb(void *user_data)
{
...
sword oci8_OCITransRollback_nb(oci8_svcctx_t *svcctx, OCISvcCtx *svchp, OCIError *errhp, ub4 flags, const char *file, int line)
{
    if (have_OCITransRollback_nb) {
        ...
        data.errhp = errhp;
        data.flags = flags;
        oci8_blocking_region(svcctx, oci8_OCITransRollback_cb, &data);
        return data.rv;
    } else {
...
static VALUE oci8_OCILobClose_cb(void *user_data)
{
...
sword oci8_OCILobClose_nb(oci8_svcctx_t *svcctx, OCISvcCtx *svchp, OCIError *errhp, OCILobLocator *locp, const char *file, int line)
{
    if (have_OCILobClose_nb) {
        ...
        data.errhp = errhp;
        data.locp = locp;
        oci8_blocking_region(svcctx, oci8_OCILobClose_cb, &data);
        return data.rv;
    } else {
...
#if defined RUNTIME_API_CHECK || ORACLE_CLIENT_VERSION >= ORAVER_8_1
static VALUE oci8_OCILobCreateTemporary_cb(void *user_data)
{
...
sword oci8_OCILobCreateTemporary_nb(oci8_svcctx_t *svcctx, OCISvcCtx *svchp, OCIError *errhp, OCILobLocator *locp, ub2 csid, ub1 csfrm, ub1 lobtype, boolean cache, OCIDuration duration, const char *file, int line)
{
    if (have_OCILobCreateTemporary_nb) {
        ...
        oci8_blocking_region(svcctx, oci8_OCILobCreateTemporary_cb, &data);
        return data.rv;
    } else {
...
#if defined RUNTIME_API_CHECK || ORACLE_CLIENT_VERSION >= ORAVER_8_1
static VALUE oci8_OCILobGetChunkSize_cb(void *user_data)
{
...
sword oci8_OCILobGetChunkSize_nb(oci8_svcctx_t *svcctx, OCISvcCtx *svchp, OCIError *errhp, OCILobLocator *locp, ub4 *chunksizep, const char *file, int line)
{
    if (have_OCILobGetChunkSize_nb) {
        ...
        oci8_blocking_region(svcctx, oci8_OCILobGetChunkSize_cb, &data);
        return data.rv;
    } else {
...
#if defined RUNTIME_API_CHECK || ORACLE_CLIENT_VERSION >= ORAVER_8_1
static VALUE oci8_OCILobLocatorAssign_cb(void *user_data)
{
...
sword oci8_OCILobLocatorAssign_nb(oci8_svcctx_t *svcctx, OCISvcCtx *svchp, OCIError *errhp, CONST OCILobLocator *src_locp, OCILobLocator **dst_locpp, const char *file, int line)
{
    if (have_OCILobLocatorAssign_nb) {
        ...
        oci8_blocking_region(svcctx, oci8_OCILobLocatorAssign_cb, &data);
        return data.rv;
    } else {
...
#if defined RUNTIME_API_CHECK || ORACLE_CLIENT_VERSION >= ORAVER_8_1
static VALUE oci8_OCILobOpen_cb(void *user_data)
{
...
sword oci8_OCILobOpen_nb(oci8_svcctx_t *svcctx, OCISvcCtx *svchp, OCIError *errhp, OCILobLocator *locp, ub1 mode, const char *file, int line)
{
    if (have_OCILobOpen_nb) {
        ...
        data.locp = locp;
        data.mode = mode;
        oci8_blocking_region(svcctx, oci8_OCILobOpen_cb, &data);
        return data.rv;
    } else {
 ...
 */
#if defined RUNTIME_API_CHECK
int oci8_have_OCIReset;
#endif

sword oci8_OCIReset(dvoid *hndlp, OCIError *errhp, const char *file, int line)
{
    if (have_OCIReset) {
        return OCIReset(hndlp, errhp);
    } else {
        rb_raise(rb_eRuntimeError, "undefined OCI function %s is called", "OCIReset");
    }
}
 ...
 */
#if defined RUNTIME_API_CHECK
int oci8_have_OCIIntervalFromText;
#endif

sword oci8_OCIIntervalFromText(dvoid *hndl, OCIError *err, CONST OraText *inpstr, size_t str_len, OCIInterval *result, const char *file, int line)
{
    if (have_OCIIntervalFromText) {
        return OCIIntervalFromText(hndl, err, inpstr, str_len, result);
    } else {
        rb_raise(rb_eRuntimeError, "undefined OCI function %s is called", "OCIIntervalFromText");
    }
}
...
static VALUE oci8_OCILobGetLength2_cb(void *user_data)
{
...
sword oci8_OCILobGetLength2_nb(oci8_svcctx_t *svcctx, OCISvcCtx *svchp, OCIError *errhp, OCILobLocator *locp, oraub8 *lenp, const char *file, int line)
{
    if (have_OCILobGetLength2_nb) {
        ...
        data.locp = locp;
        data.lenp = lenp;
        oci8_blocking_region(svcctx, oci8_OCILobGetLength2_cb, &data);
        return data.rv;
    } else {
...
#if defined RUNTIME_API_CHECK || ORACLE_CLIENT_VERSION >= ORAVER_10_1
static VALUE oci8_OCILobRead2_cb(void *user_data)
{
...
sword oci8_OCILobRead2_nb(oci8_svcctx_t *svcctx, OCISvcCtx *svchp, OCIError *errhp, OCILobLocator *locp, oraub8 *byte_amtp, oraub8 *char_amtp, oraub8 offset, dvoid *bufp, oraub8 bufl, ub1 piece, dvoid *ctxp, OCICallbackLobRead2 cbfp, ub2 csid, ub1 csfrm, const char *file, int line)
{
    if (have_OCILobRead2_nb) {
        ...
        data.csid = csid;
        data.csfrm = csfrm;
        oci8_blocking_region(svcctx, oci8_OCILobRead2_cb, &data);
        return data.rv;
    } else {
...
#if defined RUNTIME_API_CHECK || ORACLE_CLIENT_VERSION >= ORAVER_10_1
static VALUE oci8_OCILobTrim2_cb(void *user_data)
{
...
sword oci8_OCILobTrim2_nb(oci8_svcctx_t *svcctx, OCISvcCtx *svchp, OCIError *errhp, OCILobLocator *locp, oraub8 newlen, const char *file, int line)
{
    if (have_OCILobTrim2_nb) {
        ...
        data.locp = locp;
        data.newlen = newlen;
        oci8_blocking_region(svcctx, oci8_OCILobTrim2_cb, &data);
        return data.rv;
    } else {
...
#if defined RUNTIME_API_CHECK || ORACLE_CLIENT_VERSION >= ORAVER_10_1
static VALUE oci8_OCILobWrite2_cb(void *user_data)
{
...
sword oci8_OCILobWrite2_nb(oci8_svcctx_t *svcctx, OCISvcCtx *svchp, OCIError *errhp, OCILobLocator *locp, oraub8 *byte_amtp, oraub8 *char_amtp, oraub8 offset, dvoid *bufp, oraub8 buflen, ub1 piece, dvoid *ctxp, OCICallbackLobWrite2 cbfp, ub2 csid, ub1 csfrm, const char *file, int line)
{
    if (have_OCILobWrite2_nb) {
        ...
        data.csid = csid;
        data.csfrm = csfrm;
        oci8_blocking_region(svcctx, oci8_OCILobWrite2_cb, &data);
        return data.rv;
    } else {
...
typedef struct {
    ...
    OCIAdmin *admhp;
    ub4 mode;
} oci8_OCIDBShutdown_data_t;

#if defined RUNTIME_API_CHECK
int oci8_have_OCIDBShutdown_nb;
#endif

#if defined RUNTIME_API_CHECK || ORACLE_CLIENT_VERSION >= ORAVER_10_2
static VALUE oci8_OCIDBShutdown_cb(void *user_data)
{
    oci8_OCIDBShutdown_data_t *data = (oci8_OCIDBShutdown_data_t *)user_data;
    data->rv = OCIDBShutdown(data->svchp, data->errhp, data->admhp, data->mode);

    return (VALUE)data->rv;

}
#else
#define oci8_OCIDBShutdown_cb NULL
#endif

sword oci8_OCIDBShutdown_nb(oci8_svcctx_t *svcctx, OCISvcCtx *svchp, OCIError *errhp, OCIAdmin *admhp, ub4 mode, const char *file, int line)
{
    if (have_OCIDBShutdown_nb) {
        oci8_OCIDBShutdown_data_t data;
        data.svchp = svchp;
        data.errhp = errhp;
        data.admhp = admhp;
        data.mode = mode;
        oci8_blocking_region(svcctx, oci8_OCIDBShutdown_cb, &data);
        return data.rv;
    } else {
        rb_raise(rb_eRuntimeError, "undefined OCI function %s is called", "OCIDBShutdown_nb");
    }
}
...
typedef struct {
    ...
    ub4 mode;
    ub4 flags;
} oci8_OCIDBStartup_data_t;

#if defined RUNTIME_API_CHECK
int oci8_have_OCIDBStartup_nb;
#endif

#if defined RUNTIME_API_CHECK || ORACLE_CLIENT_VERSION >= ORAVER_10_2
static VALUE oci8_OCIDBStartup_cb(void *user_data)
{
    oci8_OCIDBStartup_data_t *data = (oci8_OCIDBStartup_data_t *)user_data;
    data->rv = OCIDBStartup(data->svchp, data->errhp, data->admhp, data->mode, data->flags);

    return (VALUE)data->rv;

}
#else
#define oci8_OCIDBStartup_cb NULL
#endif

sword oci8_OCIDBStartup_nb(oci8_svcctx_t *svcctx, OCISvcCtx *svchp, OCIError *errhp, OCIAdmin *admhp, ub4 mode, ub4 flags, const char *file, int line)
{
    if (have_OCIDBStartup_nb) {
        oci8_OCIDBStartup_data_t data;
        data.svchp = svchp;
        data.errhp = errhp;
        data.admhp = admhp;
        data.mode = mode;
        data.flags = flags;
        oci8_blocking_region(svcctx, oci8_OCIDBStartup_cb, &data);
        return data.rv;
    } else {
        rb_raise(rb_eRuntimeError, "undefined OCI function %s is called", "OCIDBStartup_nb");
    }
}
...
#if defined RUNTIME_API_CHECK || ORACLE_CLIENT_VERSION >= ORAVER_10_2
static VALUE oci8_OCIPing_cb(void *user_data)
{
...
sword oci8_OCIPing_nb(oci8_svcctx_t *svcctx, OCISvcCtx *svchp, OCIError *errhp, ub4 mode, const char *file, int line)
{
    if (have_OCIPing_nb) {
        ...
        data.errhp = errhp;
        data.mode = mode;
        oci8_blocking_region(svcctx, oci8_OCIPing_cb, &data);
        return data.rv;
    } else {
 ...
 */
#if defined RUNTIME_API_CHECK
int oci8_have_OCIArrayDescriptorAlloc;
#endif

sword oci8_OCIArrayDescriptorAlloc(const void *parenth, void **descpp, const ub4 type, ub4 array_size, const size_t xtramem_sz, void **usrmempp, const char *file, int line)
{
    if (have_OCIArrayDescriptorAlloc) {
        return OCIArrayDescriptorAlloc(parenth, descpp, type, array_size, xtramem_sz, usrmempp);
    } else {
        rb_raise(rb_eRuntimeError, "undefined OCI function %s is called", "OCIArrayDescriptorAlloc");
    }
}
 ...
 */
#if defined RUNTIME_API_CHECK
int oci8_have_OCIArrayDescriptorFree;
#endif

sword oci8_OCIArrayDescriptorFree(void **descp, const ub4 type, const char *file, int line)
{
    if (have_OCIArrayDescriptorFree) {
        return OCIArrayDescriptorFree(descp, type);
    } else {
        rb_raise(rb_eRuntimeError, "undefined OCI function %s is called", "OCIArrayDescriptorFree");
    }
}
...
void Init_oci8_apiwrap(void)
{
    ...
    if (oci8_OCIDescriptorFree_func == NULL)
        return;
    oci8_OCIEnvInit_func = (oci8_OCIEnvInit_func_t)oci8_find_symbol("OCIEnvInit");
    if (oci8_OCIEnvInit_func == NULL)
        return;
    ...
    if (oci8_OCIHandleFree_func == NULL)
        return;
    oci8_OCIInitialize_func = (oci8_OCIInitialize_func_t)oci8_find_symbol("OCIInitialize");
    if (oci8_OCIInitialize_func == NULL)
        return;
    ...
    if (oci8_OCILobFileSetName_func == NULL)
        return;
    oci8_OCILobGetLength_func = (oci8_OCILobGetLength_func_t)oci8_find_symbol("OCILobGetLength");
    if (oci8_OCILobGetLength_func == NULL)
        return;
    ...
    if (oci8_OCILobLocatorIsInit_func == NULL)
        return;
    oci8_OCILobRead_func = (oci8_OCILobRead_func_t)oci8_find_symbol("OCILobRead");
    if (oci8_OCILobRead_func == NULL)
        return;
    oci8_OCILobTrim_func = (oci8_OCILobTrim_func_t)oci8_find_symbol("OCILobTrim");
    if (oci8_OCILobTrim_func == NULL)
        return;
    oci8_OCILobWrite_func = (oci8_OCILobWrite_func_t)oci8_find_symbol("OCILobWrite");
    if (oci8_OCILobWrite_func == NULL)
        return;
    oci8_OCILogoff_func = (oci8_OCILogoff_func_t)oci8_find_symbol("OCILogoff");
    if (oci8_OCILogoff_func == NULL)
        return;
    oci8_OCILogon_func = (oci8_OCILogon_func_t)oci8_find_symbol("OCILogon");
    if (oci8_OCILogon_func == NULL)
        return;
    ...
    if (oci8_OCIStmtFetch_func == NULL)
        return;
    oci8_OCIStmtGetPieceInfo_func = (oci8_OCIStmtGetPieceInfo_func_t)oci8_find_symbol("OCIStmtGetPieceInfo");
    if (oci8_OCIStmtGetPieceInfo_func == NULL)
        return;
    oci8_OCIStmtPrepare_func = (oci8_OCIStmtPrepare_func_t)oci8_find_symbol("OCIStmtPrepare");
    if (oci8_OCIStmtPrepare_func == NULL)
        return;
    oci8_OCIStmtSetPieceInfo_func = (oci8_OCIStmtSetPieceInfo_func_t)oci8_find_symbol("OCIStmtSetPieceInfo");
    if (oci8_OCIStmtSetPieceInfo_func == NULL)
        return;
    ...
    have_OCILobGetLength_nb = 1;
    have_OCILobLocatorIsInit = 1;
    have_OCILobRead_nb = 1;
    have_OCILobTrim_nb = 1;
    have_OCILobWrite_nb = 1;
    have_OCILogoff_nb = 1;
    have_OCILogon_nb = 1;
    have_OCINumberAbs = 1;
    have_OCINumberAdd = 1;
    ...
    have_OCIServerDetach_nb = 1;
    have_OCIServerVersion = 1;
    have_OCISessionBegin_nb = 1;
    have_OCISessionEnd_nb = 1;
    have_OCIStmtExecute_nb = 1;
    have_OCIStmtFetch_nb = 1;
    have_OCIStmtGetPieceInfo = 1;
    have_OCIStmtPrepare = 1;
    have_OCIStmtSetPieceInfo = 1;
    ...
    if (oci8_OCINumberSign_func == NULL)
        return;
    oci8_OCIReset_func = (oci8_OCIReset_func_t)oci8_find_symbol("OCIReset");
    if (oci8_OCIReset_func == NULL)
        return;
    ...
    if (oci8_OCIDateTimeGetTimeZoneOffset_func == NULL)
        return;
    oci8_OCIIntervalFromText_func = (oci8_OCIIntervalFromText_func_t)oci8_find_symbol("OCIIntervalFromText");
    if (oci8_OCIIntervalFromText_func == NULL)
        return;
    ...
    if (oci8_OCIClientVersion_func == NULL)
        return;
    oci8_OCIDBShutdown_func = (oci8_OCIDBShutdown_func_t)oci8_find_symbol("OCIDBShutdown");
    if (oci8_OCIDBShutdown_func == NULL)
        return;
    oci8_OCIDBStartup_func = (oci8_OCIDBStartup_func_t)oci8_find_symbol("OCIDBStartup");
    if (oci8_OCIDBStartup_func == NULL)
        return;
    ...
    have_OCIDBShutdown_nb = 1;
    have_OCIDBStartup_nb = 1;
    have_OCIPing_nb = 1;

    /*
     * checking Oracle 11.1.0 API
     */
    oci8_OCIArrayDescriptorAlloc_func = (oci8_OCIArrayDescriptorAlloc_func_t)oci8_find_symbol("OCIArrayDescriptorAlloc");
    if (oci8_OCIArrayDescriptorAlloc_func == NULL)
        return;
    oci8_OCIArrayDescriptorFree_func = (oci8_OCIArrayDescriptorFree_func_t)oci8_find_symbol("OCIArrayDescriptorFree");
    if (oci8_OCIArrayDescriptorFree_func == NULL)
        return;
    /* pass Oracle 11.1.0 API */
    oracle_client_version = ORAVER_11_1;
    have_OCIArrayDescriptorAlloc = 1;
    have_OCIArrayDescriptorFree = 1;
}
